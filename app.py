...
def get_ai_reply(user_input):
    ...
    data = {
        ...
        "messages": [
            {
                "role": "system",
                "content": "Kamu pembantu AI comel dan mesra. Bantu pengguna claim dan cashout Worldcoin ke wallet Malaysia. Tambah emoji bila sesuai."
            },
            {
                "role": "user",
                "content": user_input
...
def handle_admin(message):
    bot.send_message(message.chat.id, "📞 Anda boleh hubungi Encik Khairul (Admin bot ini) di nombor: 01136954562")
